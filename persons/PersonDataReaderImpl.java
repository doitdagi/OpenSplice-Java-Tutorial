...
public class PersonDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements PersonDataReader
{
    private long copyCache;
    private PersonTypeSupport typeSupport;

    public PersonDataReaderImpl(persons.PersonTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            persons.PersonSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            persons.PersonHolder received_data,
    ...
    */
    ...
    {
        return new PersonDataReaderViewImpl(typeSupport);
    }
}
