...
public class PersonDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements PersonDataWriter
{
    private long copyCache;
    private PersonTypeSupport typeSupport;

    public PersonDataWriterImpl(persons.PersonTypeSupport ts)
    {
        typeSupport = ts;
