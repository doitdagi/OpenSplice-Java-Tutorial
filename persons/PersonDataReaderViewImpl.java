...
public class PersonDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements PersonDataReaderView
{
    private long copyCache;
    private PersonTypeSupport typeSupport;

    public PersonDataReaderViewImpl(persons.PersonTypeSupport ts)
    {
        typeSupport = ts;
